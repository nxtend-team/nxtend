...
describe('application', () => {
  ...
  describe('--template', () => {
    it('should add base template files', async () => {
      ...
      expect(
        appTree.exists(`${projectRoot}/src/app/theme/variables.css`)
      ).toBeTruthy();
    });
    ...
    it('should add blank template files', async () => {
      ...
      expect(
        appTree.exists(`${projectRoot}/src/app/components/ExploreContainer.tsx`)
      ).toBeTruthy();
    });
    ...
    it('should add list template files', async () => {
      ...
      expect(
        appTree.exists(`${projectRoot}/src/app/pages/ViewMessage.tsx`)
      ).toBeTruthy();
    });
    ...
    it('should add sidemenu template files', async () => {
      ...
      expect(
        appTree.exists(`${projectRoot}/src/app/pages/Page.tsx`)
      ).toBeTruthy();
    });
    ...
    it('should add tabs template files', async () => {
      ...
      expect(
        appTree.exists(`${projectRoot}/src/app/pages/Tab1.tsx`)
      ).toBeTruthy();
    });
  });
